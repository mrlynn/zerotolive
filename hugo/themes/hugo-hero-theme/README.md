...
Zero to Live is a fork of Hero and is a multi-page business theme with fullscreen hero images and fullwidth sections.
...
If you fork or copy this theme the LICENSE file and the copyright notice on line 3 (where the original author is listed as the author) must not be changed. You cannot just replace the copyright line with your own name. Attribution in your README.md or on your site is also welcome but not required.
