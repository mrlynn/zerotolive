# Hugo Zero to Live (ZtL) Theme

ZtL is a multi-page business theme with fullscreen hero images and fullwidth sections.

[Live Demo](https://zerotolive.com/) |
[Installation](#installation) | 

![Hugo Zero to Live Theme screenshot](https://github.com/mrlynn/hugo-zero-to-live/blob/master/images/screenshot-full.jpg)
...
```
cd mynewsite
git clone https://github.com/mrlynn/hugo-zero-to-live.git themes/hugo-zero-to-live
```

### Install theme from .zip file

You can download the .zip file located here https://github.com/mrlynn/hugo-zero-to-live/archive/master.zip.

Extract the downloaded .zip inside the `themes` folder. Rename the extracted folder from `hugo-zero-to-live-master` -> `hugo-zero-to-live`. You should end up with the following folder structure `mynewsite/themes/hugo-zero-to-live`

### Copy example content

Copy the entire contents of the `mynewsite/themes/hugo-zero-to-live/exampleSite/` folder to root folder of your Hugo site, ie `mynewsite/`

To copy the files using terminal, make sure you are still in the projects root, ie the `mynewsite` folder.

```
cp -a themes/hugo-zero-to-live/exampleSite/. .
```
